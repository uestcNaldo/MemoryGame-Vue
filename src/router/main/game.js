...
let time = 0
let timer = null
let timeObject = {h: 0, m: 0, s: 0}
let timeDisplay = {h: '00', m: '00', s: '00'}
...
function setCardsSuccess (list) {
  let $game = $('#game')
  list.forEach(function (t) {
    let itemCard = $game.find('>.card').eq(t.index)
...
function setCardsFail (list) {
  ...
  list.forEach(function (t) {
    ...
    window.setTimeout(delayFailed, 500, itemCard, frontSide, backSide)
  })
}
